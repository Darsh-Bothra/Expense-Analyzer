...
from app.observability import StepTimer, record_run, snapshot
...
@app.post("/datasets/{dataset_id}/chat", response_model=ChatResponse)
...
@app.get("/datasets/{dataset_id}/messages", response_model=list[ChatMessageOut])
